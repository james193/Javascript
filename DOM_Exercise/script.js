...
function func3(){
    ...
    if(keyw=="issue_count") ans = myBooks[d]["issue_count"];
    if(keyw=="branches") ans = myBooks[d]["branches"];
    if(keyw=="contributors") ans = myBooks[d]["contributors"];
    if(keyw=="star") ans = myBooks[d]["star"];
    if(keyw=="commit") ans = myBooks[d]["commit"];
    if(keyw=="watchers") ans = myBooks[d]["watchers"];
